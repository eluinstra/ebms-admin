...
=====================================
show help:
> java -cp ebms-admin-1.x.x.jar nl.clockwork.ebms.admin.Start -h

start with hsqldb server:
> java -cp ebms-admin-1.x.x.jar nl.clockwork.ebms.admin.Start -hsqldb

=====================================================
= Start EbMS Admin Console with embedded EbMS adapter
=====================================================
show help:
> java -cp ebms-admin-1.x.x.jar nl.clockwork.ebms.admin.StartEmbedded -h

start with hsqldb server:
> java -cp ebms-admin-1.x.x.jar nl.clockwork.ebms.admin.StartEmbedded -hsqldb
