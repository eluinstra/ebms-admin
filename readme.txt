ebms-admin-2.16.2.jar needs jdk 8 and is compiled and tested with openjdk 8
...
start:
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.Start
...
> java -Dlog4j.configurationFile=properties/log4j2.xml -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.Start

start without using the default java truststore:
> java -Djavax.net.ssl.trustStore= -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.Start
...
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.Start -authentication

When you start you can see the following information in the console:
Using properties files directory: 
Using keyStore jar:file:/home/digipoort/ebms-admin-2.16.2.jar!/keystore.p12
Using trustStore jar:file:/home/digipoort/ebms-admin-2.16.2.jar!/truststore.p12
Web server configured on https://localhost:8443/
Configuring web server client certificate authentication:
Using clientTrustStore jar:file:/home/digipoort/ebms-admin-2.16.2.jar!/clientTruststore.p12
Starting web server...
...
=====================================================
show help:
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -h
usage: Start [-authentication] [-clientAuthentication]
       [-clientCertificateHeader <arg>] [-clientTrustStorePassword <arg>]
       [-clientTrustStorePath <arg>] [-clientTrustStoreType <arg>] [-h]
...
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -hsqldb

start using a postgresql jdbc driver:
> java -cp postgresql-9.3-1102-jdbc41.jar:ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded

start on port 8000 (instead of 8080):
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -port 8000

start with soap interface:
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -soap
...
start with a log4j2 file properties/log4j2.xml:
> java -Dlog4j.configurationFile=properties/log4j2.xml -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded

start without using the default java truststore:
> java -Djavax.net.ssl.trustStore= -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded
...
start using basic authentication
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -authentication
...
- copy ebms-admin-2.16.2.jar to overheid
- start admin console on port 8000 with a hsqldb server:
> java -cp ebms-admin-2.16.2.jar nl.clockwork.ebms.admin.StartEmbedded -port 8000 -hsqldb
...
- copy ebms-admin-2.16.2.jar to digipoort
