...
public class LoggingEventListener implements EventListener
{
	...
	{
		TestMessageRegistry.getInstance().setMessageStatus(messageId, EbMSMessageStatus.DELIVERED);
		logger.info("TEST !!! Message " + messageId + " delivered");
	}
	
	@Override
	public void onMessageFailed(String messageId) throws EventException
	{
		TestMessageRegistry.getInstance().setMessageStatus(messageId, EbMSMessageStatus.DELIVERY_FAILED);
