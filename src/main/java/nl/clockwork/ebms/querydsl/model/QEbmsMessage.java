...
public class QEbmsMessage extends com.querydsl.sql.RelationalPathBase<QEbmsMessage>
{
	...
	public final com.querydsl.sql.ForeignKey<QEbmsAttachment> _sysFk10141 =
			createInvForeignKey(Arrays.asList(messageId,messageNr),Arrays.asList("MESSAGE_ID","MESSAGE_NR"));
