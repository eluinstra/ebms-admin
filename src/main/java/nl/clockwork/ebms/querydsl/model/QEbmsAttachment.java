...
public class QEbmsAttachment extends com.querydsl.sql.RelationalPathBase<QEbmsAttachment>
{
	...
	public final com.querydsl.sql.ForeignKey<QEbmsMessage> sysFk10141 =
			createForeignKey(Arrays.asList(messageId, messageNr), Arrays.asList("message_id", "message_nr"));
