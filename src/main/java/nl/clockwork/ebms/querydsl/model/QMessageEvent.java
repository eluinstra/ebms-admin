...
public class QMessageEvent extends com.querydsl.sql.RelationalPathBase<QMessageEvent>
{
	...
	public final EnumPath<nl.clockwork.ebms.common.event.MessageEventType> eventType =
			createEnum("eventType", nl.clockwork.ebms.common.event.MessageEventType.class);
