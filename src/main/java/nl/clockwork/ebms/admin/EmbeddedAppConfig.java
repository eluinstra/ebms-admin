...
@Import({AdminDAOConfig.class, CertificateMappingServiceConfig.class, CacheConfig.class, CommonConfig.class, CPAManagerConfig.class, CPAServiceConfig.class,
		...
		JMSConfig.class, KafkaConfig.class, KeyStoreConfig.class, MessageEventListenerConfig.class, QueryDSLConfig.class, SchedulerConfig.class,
		SigningConfig.class, TransactionManagerConfig.class, URLMappingServiceConfig.class, ValidationConfig.class})
@PropertySource(
