...
public enum EbMSMessageTrafficChartSerie
{
	...
	SEND_STATUS("Sending",SimpleColor.BLUE,Color.BLUE,new EbMSMessageStatus[]{EbMSMessageStatus.CREATED,EbMSMessageStatus.DELIVERED,EbMSMessageStatus.DELIVERY_FAILED,EbMSMessageStatus.EXPIRED});
