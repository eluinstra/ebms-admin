...
public class JavaTrustStorePropertiesFormPanel extends Panel
{
	...
	@Builder
	public JavaTrustStorePropertiesFormPanel(String id, IModel<JavaTrustStorePropertiesFormData> model, boolean required, SerializableSupplier<Boolean> isVisible)
	{
		super(id, model);
		...
		private EbMSButton createTestButton(String id)
		{
			Action action = () ->
			{
				try
				{
					...
					Utils.testTrustStore(o.getType(), Objects.requireNonNull(o.getUri()), Objects.requireNonNull(o.getPassword()));
