...
# Keyvault uri is the full https uri of the keyvault to be used
azure.keyvault.uri=https://key.vault.azure.net

# Tennant id is the guid of the tennant/organisation where the keyvault is created
azure.keyvault.tennantid=f487d075-71f0-486a-beab-7e8d3f873be5

# The clientid of the (application) registered, which should have sufficient privileges on the keyvault
azure.keyvault.clientid=https://digipoort

# The client secret as generated by azure
azure.keyvault.client.secret=_17c.3xulKW~2crwjVTFRT8n-5LKo44uF5

# the defaultAliases should be the name of the certificate in the keystore
client.keystore.defaultAlias=kvgenerated
keystore.defaultAlias=kvgenerated
```
